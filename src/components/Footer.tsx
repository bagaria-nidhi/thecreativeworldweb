    ...
    <footer className="bg-kids-navy text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <Link
                to="https://www.facebook.com/profile.php?id=100057330135202"
                target="_blank"
                className="w-10 h-10 bg-white/10 hover:bg-kids-pink rounded-full flex items-center justify-center transition-all"
              >
                <Facebook className="h-5 w-5" />
              </Link>
              <Link
                to="https://www.instagram.com/the.creativeworldofficial?igsh=MTJucTBkazNvcGF3cQ=="
                target="_blank"
                className="w-10 h-10 bg-white/10 hover:bg-kids-pink rounded-full flex items-center justify-center transition-all"
              >
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center text-white/60">
          <p>&copy; 2026 The Creative World. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
